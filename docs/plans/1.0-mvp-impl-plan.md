...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-1.1–MVP-1.4
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-2.1–MVP-2.8
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-3.1–MVP-3.6
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-4.1–MVP-4.6
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-5.1–MVP-5.11
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-6.1–MVP-6.4
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-7.1–MVP-7.21
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-8.1–MVP-8.12
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-9.1–MVP-9.7
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-10.1–MVP-10.7
...
**增量**：channels模块（ChannelAdapter Protocol、SSEChannel实现）、GET /events/stream端点、SSE连接管理（按user_id分组，用户级连接）、SSE推送10种事件类型（9业务+agent_status_changed）

**依赖**：步骤10（消息API，SSE推送消息事件）

**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-11.1–MVP-11.6
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-12.1–MVP-12.12
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-13.1–MVP-13.6
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-14.1–MVP-14.7
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-15.1–MVP-15.7
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-16.1–MVP-16.6
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-17.1–MVP-17.4
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-18.1–MVP-18.4
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-19.1–MVP-19.9
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-20.1–MVP-20.6
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-21.1–MVP-21.9
...
**测试设计**：见 [1-mvp-test-design](1-mvp-test-design.md) MVP-22.1–MVP-22.6
